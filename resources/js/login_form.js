...
let disablebtnUser = true;
let disablebtnEmail = true;
let disablebtnPass = true;

function validateForm () {
    if (disablebtnUser === false && disablebtnEmail === false && disablebtnPass === false) {
        return true;
    } else {
        return false;
    }
...
//        alert(data);
//    });
document.getElementById('button').addEventListener('click', ajaxrequest);
